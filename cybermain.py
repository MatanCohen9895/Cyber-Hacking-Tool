...
#End mssp
window = tk.Tk()
window.title("Matan Cohen")
greeting = tk.Label(text="Cyber Haking tool by:Matan Cohen", font="Helvetica")
greeting1 = tk.Label(text="Welcome to the advanced hacking tool \n designed for the novice hacker who wants to become a pro\n Please select the cyber operation you want to perform: ", font="italic")
greeting.pack()
greeting1.pack()
